...
markets = [
   ...
   {'id':6, 'alias': 'Soy Beans', 'epic': 'CC.D.BO.USS.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.6, 'minimumStop' : {'value': null, 'type': 'points'}, 'minimumSize' : {'value': null, 'type': 'points'}, 'size': 5, 'marketClosed' : [19,1], 'expiry': 'DFB', 'streamingPricesAvailable': false },
   {'id':7, 'alias': 'NOKJPY', 'epic': 'CS.D.NOKJPY.TODAY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.6, 'minimumStop' : {'value': null, 'type': 'points'}, 'minimumSize' : {'value': null, 'type': 'points'}, 'size': 5, 'marketClosed' : [0,0], 'expiry': 'DFB', 'streamingPricesAvailable': true },
   ...
   {'id':9, 'alias': 'NZDGBP', 'epic': 'CS.D.NZDGBP.TODAY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.6, 'minimumStop' : {'value': null, 'type': 'points'}, 'minimumSize' : {'value': null, 'type': 'points'}, 'size': 50, 'marketClosed' : [0,0], 'expiry': 'DFB', 'streamingPricesAvailable': false }
 ];
