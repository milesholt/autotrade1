...
//Main parameters
markets = [
   {'id':0, 'alias': 'Carbon Emissions', 'epic': 'CO.D.CFI.Month1.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 0.5, 'marketClosed' : [16,7], 'expiry': 'DEC-22', 'streamingPricesAvailable': true  },
   {'id':1, 'alias': 'MXNJPY', 'epic': 'CS.D.MXNJPY.TODAY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4,'minimumStop' : {'value': null, 'type': 'points'}, 'size': 10, 'marketClosed' : [0,0], 'expiry': 'DFB', 'streamingPricesAvailable': true  },
   {"id":2, "alias": "Spot Gold", "epic": "CS.D.USCGC.TODAY.IP", "data": {}, "deal": {}, "tradedBefore" : false, "stopDistancePerc" : 0.4, 'limitDistancePerc' : 0.4, "minimumStop" : {"value": null, "type": "points"}, 'size': 5, 'marketClosed' : [21,23], 'expiry': 'DFB', 'streamingPricesAvailable': true  },
   {'id':3, 'alias': 'Chicago Wheat', 'epic': 'CC.D.W.USS.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 5, 'marketClosed' : [19,1], 'expiry': 'DFB', 'streamingPricesAvailable': true },
   {'id':4, 'alias': 'London Gas Oil', 'epic': 'CC.D.LGO.USS.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 5, 'marketClosed' : [22,1], 'expiry': 'DFB', 'streamingPricesAvailable': true },
   {'id':5, 'alias': 'Spot Silver', 'epic': 'CS.D.USCSI.TODAY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 10, 'marketClosed' : [0,0], 'expiry': 'DFB', 'streamingPricesAvailable': true },
   {'id':6, 'alias': 'Rolls Royce', 'epic': 'KA.D.RR.DAILY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 5, 'marketClosed' : [16,8], 'expiry': 'DFB', 'streamingPricesAvailable': false },
   {'id':7, 'alias': 'NOKJPY', 'epic': 'CS.D.NOKJPY.TODAY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 5, 'marketClosed' : [0,0], 'expiry': 'DFB', 'streamingPricesAvailable': true },
   {'id':8, 'alias': 'Alto Ingredients', 'epic': 'UC.D.PEIXUS.DAILY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 1, 'marketClosed' : [20,14], 'expiry': 'DFB', 'streamingPricesAvailable': false },
   {'id':9, 'alias': 'LLoyds Banking Group', 'epic': 'KA.D.LLOY.DAILY.IP', 'data': {}, 'deal': {}, 'tradedBefore' : false, 'stopDistancePerc' : 0.4, 'limitDistancePerc' : 0.4, 'minimumStop' : {'value': null, 'type': 'points'}, 'size': 50, 'marketClosed' : [16,8], 'expiry': 'DFB', 'streamingPricesAvailable': false }
 ];
