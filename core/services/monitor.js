    ...
    if(positionsData.positions.length){
      ...
      positionsData.positions.forEach(async (position,i) => {
          if(position.dealId = dealId){
                    ...
                    await stream.actions.startStream(epic);
                          ...
                          if (/^[\],:{}\s]*$/.test(data.toString().replace(/\\["\\\/bfnrtu]/g, '@').
                           ...
                           replace(/(?:^|:|,)(?:\s*\[)+/g, ''))) {
                                ...
                                let closePrice = direction == 'BUY' ? d.closePrice.bid : d.closePrice.ask;
                                  ...
                                  console.log('close ask: ' + d.closePrice.ask + 'close bid: ' + d.closePrice.bid + ' newlimit: ' + newlimit + ' stoplevel: ' + p.stopLevel + ' updated: ' + modtime);
