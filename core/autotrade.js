...
actions.setDefaults = async function(){
  ...
  from_1week = moment.utc().local().subtract(7, 'days').format('YYYY-MM-DD%2000:00:00');
  from_3days = moment.utc().local().subtract(3, 'days').format('YYYY-MM-DD%2000:00:00');
  from_4hours =  moment.utc().local().subtract(4, 'hours').format('YYYY-MM-DD%20HH:00:00');
  from_1hour = moment.utc().local().subtract(1, 'hours').format('YYYY-MM-DD%20HH:00:00');
