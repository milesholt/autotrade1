...
//   };
  ...
  actions.finalAnalysis = async function(){
    analysis = {
      ...
      'confirmationTrendPoints': trend4Hours !== 'ranging' ? confirmationData.trendPoints : 'none',
      'confirmationPoints': trend4Hours !== 'ranging' ? confirmationData.confirmationPoints.x : 'none',
