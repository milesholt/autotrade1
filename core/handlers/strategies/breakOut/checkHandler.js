...
actions.finalChecks = async function(){
  ...
  //If 4hour trend not ranging, update previous trend of 4 hours, even if it is now ranging, we just need to know whether firstClose is higher or lower without rangelimit
